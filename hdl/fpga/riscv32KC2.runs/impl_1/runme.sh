...
HD_PWD='F:/Work/risv32KC2/hdl/fpga/riscv32KC2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv32KC2_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riscv32KC2_fpga.tcl -notrace
