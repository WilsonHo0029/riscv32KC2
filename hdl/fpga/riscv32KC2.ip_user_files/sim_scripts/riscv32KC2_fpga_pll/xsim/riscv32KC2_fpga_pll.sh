...
#
# Script generated by Vivado on Sun Mar 08 00:14:20 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : riscv32KC2_fpga_pll.sh
...
#
# Usage        : riscv32KC2_fpga_pll.sh
#                riscv32KC2_fpga_pll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                riscv32KC2_fpga_pll.sh [-rerun]
#                riscv32KC2_fpga_pll.sh [-reset_run]
#                riscv32KC2_fpga_pll.sh [-clean]
#                riscv32KC2_fpga_pll.sh [-reset_log]
#                riscv32KC2_fpga_pll.sh [-help]
#
...
# script info
echo -e "riscv32KC2_fpga_pll.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./riscv32KC2_fpga_pll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot riscv32KC2_fpga_pll xil_defaultlib.riscv32KC2_fpga_pll xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim riscv32KC2_fpga_pll -key {Behavioral:sim_1:Functional:riscv32KC2_fpga_pll} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb riscv32KC2_fpga_pll.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./riscv32KC2_fpga_pll.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: riscv32KC2_fpga_pll.sh [-help]\n\
Usage: riscv32KC2_fpga_pll.sh [-step]\n\
Usage: riscv32KC2_fpga_pll.sh [-lib_map_path]\n\
Usage: riscv32KC2_fpga_pll.sh [-rerun]\n\
Usage: riscv32KC2_fpga_pll.sh [-reset_run]\n\
Usage: riscv32KC2_fpga_pll.sh [-clean]\n\
Usage: riscv32KC2_fpga_pll.sh [-reset_log]\n\
Usage: riscv32KC2_fpga_pll.sh [-keep_index]\n\
Usage: riscv32KC2_fpga_pll.sh [-noclean_files]\n\n\
